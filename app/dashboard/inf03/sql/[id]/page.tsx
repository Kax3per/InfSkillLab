...
import {
  validateSql,
  validateQuiz,
} from "@/lib/lessons/sql/validateSql"

import {
  sqlLessons,
  sqlSummaries,
} from "@/lib/lessons/sql/indexSql"
          ...
          <CardContent className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              ...
              {lessonId >= 20 ? (
                ...
                <Link
                  href={`/dashboard/inf03/sql/${lessonId + 1}`}
                  className="w-full"
                >
              ...
              {current.type === "code-task" && (
                ...
                <div className="space-y-8">
                  ...
                  <div className="rounded-[28px] border border-black/10 dark:border-white/10 bg-white/80 dark:bg-white/[0.03] p-6 md:p-8">
                    ...
                    <p className="text-sm uppercase tracking-[0.2em] text-orange-500 font-semibold mb-4">
                      Zadanie
                    </p>
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    {validationErrors.map(
                      (error, index) => (
                        <div
                          key={index}
                          className="p-4 rounded-2xl bg-orange-500/10 border border-orange-500/20 text-orange-500"
                        >
                          ❌ {error}
                        </div>
                      )
