...
const lessons = [
  ...
  {
    id: 19,
    title: "Optymalizacja i dobre praktyki",
    icon: "⚡",
  },
  {
    id: 20,
    ...
    <div className="relative min-h-screen overflow-hidden bg-white dark:bg-black text-black lesson-scroll dark:text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="dark:hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-yellow-200/30 rounded-full blur-[120px]" />

          <div className="absolute bottom-10 right-10 w-80 h-80 bg-orange-402000/30 rounded-full blur-[140px]" />
        </div>

        {/* DARK */}
        <div className="hidden dark:block">
          <div className="absolute top-20 left-10 w-72 h-72 bg-yellow-300/20 rounded-full blur-[140px]" />

          <div className="absolute bottom-10 right-10 w-80 h-80 bg-orange-500/20 rounded-full blur-[160px]" />
        </div>
          ...
          {lessons.map((lesson) => {
            ...
            if (unlocked) {
              return (
                <Link
                  key={lesson.id}
                  href={`/dashboard/inf03/js/${lesson.id}`}
                >
                  ...
                  >
                    ...
                    {/* glow */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity bg-yellow-300/5" />
